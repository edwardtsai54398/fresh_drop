        ...
        <ul class="order_history">
            <li class="order_item collapse" v-for="(order, ordIndex) in orderHistory" :key="order.ordNum">
                <div class="order_info">
                    ...
                    <p v-if="order.ord_status == 0 || order.ord_status == 1">狀態：處理中</p>
                    <p v-else-if="order.ord_status == 3">狀態：配送中</p>
                    <p v-else-if="order.ord_status == 4">狀態：已送達</p>
                    <p v-else-if="order.ord_status == 5">狀態：已取消</p>
